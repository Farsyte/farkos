...
{   parameter lambert is lex(). // lambert equation solver.
    ...
    //
    // TODO: periodically verify that licensing on my project is compatible
    // with the GPLv3 licensing of this content. If any conflict arises, my
    // intention is that the conflict is resolved in favor of satisfying the
    // licensing requirements for this file.
    //
    // NOTE: I had been looking for the Izzo paper, and the link below was
    ...
    // "Revisiting Lambert’s problem" by Dario Izzo, available at
